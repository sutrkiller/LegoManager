...
public interface ModelDao {
     ...
     * @throws LegoPersistenceException if model is already stored or violate
     * constraint (e.g. unique name).
     */
     ...
     * @throws IllegalArgumentException when model is null
     * @throws LegoPersistenceException if model is not found in storage or if
     ...
     * @throws IllegalArgumentException when model is null
     * @throws EntityNotExistsException if entity is already removed or is not
     * in storage.
     */
     ...
     * @throws EntityNotExistsException if model with given id was not found in
     * storage
     */
    ...
    /**
     * find models by its category. Models with category has to exists.
     *
     * @param category category of models
     * @return all stored models with given category
